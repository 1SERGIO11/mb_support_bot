    ...
    def _read_config(self) -> tuple[str, dict]:
        ...
        cfg = {
            ...
            'contact_unlocked_msg': (
                ...
                '<b>Что написать:</b> опишите проблему одним сообщением, добавьте устройство, приложение, провайдера '
                'и пример сайта/сервиса. При необходимости прикрепите скриншот. Оператор ответит здесь же.'
            ),
        }
